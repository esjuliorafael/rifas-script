...
class Boleto {
    ...
    // Obtener números ocupados (Para el Grid del frontend)
    ...
    public function reservar($datos) {
        // Verificamos si ya está ocupado antes de insertar (doble check)
    ...
    // Obtener lista de Ventas (Para el Admin)
    public function obtenerVentas($rifa_id = null) {
        // Hacemos JOIN para traer el nombre de la rifa
    ...
    // Cambiar estado (De pendiente a pagado)
